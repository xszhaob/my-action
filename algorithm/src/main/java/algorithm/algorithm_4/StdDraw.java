...
public class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code algorithm.algorithm_4.StdDraw.BLACK}, {@code algorithm.algorithm_4.StdDraw.BLUE}, {@code algorithm.algorithm_4.StdDraw.CYAN},
     * {@code algorithm.algorithm_4.StdDraw.DARK_GRAY}, {@code algorithm.algorithm_4.StdDraw.GRAY}, {@code algorithm.algorithm_4.StdDraw.GREEN},
     * {@code algorithm.algorithm_4.StdDraw.LIGHT_GRAY}, {@code algorithm.algorithm_4.StdDraw.MAGENTA}, {@code algorithm.algorithm_4.StdDraw.ORANGE},
     * {@code algorithm.algorithm_4.StdDraw.PINK}, {@code algorithm.algorithm_4.StdDraw.RED}, {@code algorithm.algorithm_4.StdDraw.WHITE}, and
     * {@code algorithm.algorithm_4.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to algorithm.algorithm_4.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to algorithm.algorithm_4.StdDraw)
        try {
            URL url = algorithm.algorithm_4.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
