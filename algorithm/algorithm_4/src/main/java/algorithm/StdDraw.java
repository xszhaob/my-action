...
public class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code algorithm.StdDraw.BLACK}, {@code algorithm.StdDraw.BLUE}, {@code algorithm.StdDraw.CYAN},
     * {@code algorithm.StdDraw.DARK_GRAY}, {@code algorithm.StdDraw.GRAY}, {@code algorithm.StdDraw.GREEN},
     * {@code algorithm.StdDraw.LIGHT_GRAY}, {@code algorithm.StdDraw.MAGENTA}, {@code algorithm.StdDraw.ORANGE},
     * {@code algorithm.StdDraw.PINK}, {@code algorithm.StdDraw.RED}, {@code algorithm.StdDraw.WHITE}, and
     * {@code algorithm.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to algorithm.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to algorithm.StdDraw)
        try {
            URL url = algorithm.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
