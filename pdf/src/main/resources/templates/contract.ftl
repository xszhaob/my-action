    ...
    <body>
        ...
        <table style="border-collapse:collapse;margin:10px 0;borderColor:#000000;height:40;cellPadding:1;width:100%;" align="center" border="1" >
            <tr>
              ...
              <td align="center" valign="middle">品目</td>
              <td align="center" valign="middle">品牌</td>
              <td align="center" valign="middle">产品型号</td>
            ...
            <#list orderList as order>
                <tr>
                    <td align="center" valign="middle">${order?counter}</td>
                    <td align="center" valign="middle">${order.item}</td>
                    <td align="center" valign="middle">${order.brand!"无品牌"}</td>
                    <td align="center" valign="middle">${order.model}</td>
                    <td align="center" valign="middle">${order.unitPrice}</td>
                    <td align="center" valign="middle">${order.count}</td>
                    <td align="center" valign="middle">${order.totalMoney}</td>
                </tr>
            </#list>
        </table>
    </body>
