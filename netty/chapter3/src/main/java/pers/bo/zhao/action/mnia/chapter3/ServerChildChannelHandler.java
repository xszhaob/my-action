...
public class ServerChildChannelHandler extends SimpleChannelInboundHandler<ByteBuf> {

    @Override
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        System.out.println("ServerChildChannelHandler 新连接客户端：" + ctx.channel().remoteAddress());
...
//        System.out.println(ctx.channel().eventLoop().inEventLoop());
        ...
        msg.readBytes(bytes);
        System.out.println(new Date() + "ServerChildChannelHandler Server 接收消息：" + new String(bytes));
